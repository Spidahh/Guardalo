document.addEventListener('DOMContentLoaded', () => {
    ...
    const animeData = [
        ...
        { title: "DAN DA DAN", genres: ["Shonen"], year: 2024, img: "img/dan_da_dan.jpg", studio: "Science SARU", stato: "In corso", synopsis: "Una ragazza che crede negli spiriti e un ragazzo che crede negli alieni fanno una scommessa per dimostrare chi ha ragione. Finiranno per scoprire che entrambi esistono, venendo risucchiati in un'avventura bizzarra e sovrannaturale.", structure: [{ name: "Stagione 1", episodes: "24 (in corso)" }] },
        ...
        { title: "Sakamoto Days", genres: ["Shonen"], year: 2025, img: "img/sakamoto_days.jpg", studio: "TMS Entertainment", stato: "In corso", synopsis: "Taro Sakamoto era il più grande sicario di tutti i tempi, ma si è ritirato per amore. Ora gestisce un minimarket e deve proteggere la sua vita pacifica da ex colleghi e rivali, senza mai più uccidere.", structure: [{ name: "Stagione 1", episodes: "TBA" }] },
